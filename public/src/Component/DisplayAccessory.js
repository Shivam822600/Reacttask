...
export default function DisplayAccessory(props)
{ const[list,setList]=useState()
  ...
  var result=await postData("accessories/deleteaccessory",body)
  if(result)
  {
   swal({
...
else
{
 swal({
  ...
  const handleClick=async()=>{
   ...
   var result=await postData('accessories/editaccessorydata',body)
...
const handleClickSaveIcon=async()=>{
  ...
  var result=await postDataAndImage('accessories/editicon',formData,config)
  if(result)
  {
   swal({
          ...
          { title: 'Price', field: 'price' },
          {
            ...
            render: (rowData) => (
              <div style={{ flexDirection: "column" }}>
                ...
                <div>
                  {rowData.stock}/{rowData.rented}
                </div>
              </div>
            ),
          },
          {
            title: "RentAmt/Discount",
            field: "rentamt",
            render: (rowData) => (
              <div style={{ flexDirection: "column" }}>
             
                <div>
                  {rowData.rentamt}/{rowData.discount}
                </div>
              </div>
            ),
          },
