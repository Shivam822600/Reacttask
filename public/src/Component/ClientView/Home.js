...
const fetchAllGamesOffers=async()=>{
...
const fetchAllaccessoriesOffers=async()=>{
    var list=await getData('accessories/accessoriesoffers')
    setaccessories(list)
    //alert(JSON.stringify(list))
            ...
            <div>
               ...
               <Paper elevation={3} className={classes.paperstyle}>
                ...
                <div style={{fontSize:16, padding:10}}>
                 ...
                 Day Price:Price<s> &#8377;{item.rentamt}</s>  <span><b> &#8377; {item.discount}</b></span>
    ...
    return(
        ...
        return(
            <div style={{border:'1px solid #ecf0f1',width:250, justifyContent:'center', alignItems:'center',  display:'flex', flexDirection: 'column', padding:10, margin:5}}>
                ...
                <div style={{fontSize:14,fontWeight:'bold', padding:10}}>
                {item.gamename.length<=20?item.gamename.toUpperCase():item.gamename.toUpperCase().substring(0,18)+"..."}</div>
                <div style={{fontSize:16, padding:10}}>
