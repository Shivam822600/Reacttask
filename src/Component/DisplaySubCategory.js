 ...
 swal({
  ...
  const handleClick=async()=>{
   ...
   var body={subcategoryid:subcategoryid,
    ...
    price: categoryPrice,
    stock: categoryStock,
    rented: categoryRented,
    rentamt: categoryRentamt,
    discount: discount,
    adstatus: adstatus}
...
<Grid item xs={12} >
     ...
     <Grid item xs={12} >
             <TextField value={categoryPrice} onChange={(event)=> setCategoryPrice(event.target.value)} label="Price" variant="outlined" fullWidth/>
             </Grid>

         <Grid item xs={12} >
             <TextField value={categoryStock} onChange={(event)=> setCategoryStock(event.target.value)} label="Stock" variant="outlined" fullWidth/>
             </Grid>  

          <Grid item xs={12} >
             <TextField value={categoryRented} onChange={(event)=> setCategoryRented(event.target.value)}  label="Rented" variant="outlined" fullWidth/>
             </Grid>

          <Grid item xs={12} >
             <TextField value={categoryRentamt} onChange={(event)=> setCategoryRentamt(event.target.value)} label="Rentamt" variant="outlined" fullWidth/>
             </Grid>
  <Grid item xs={12} >
...
///////////////////////////Edit Dialog ///////////////////////////////
  ...
  const handleClickOpen = (rowData) => {
    ...
    setCategoryPrice(rowData.price)
    setCategoryStock(rowData.stock)
    setCategoryRented(rowData.rented)
    setCategoryRentamt(rowData.rentamt)
